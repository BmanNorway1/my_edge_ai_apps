...
#include "nordic-axon-model/nrf_axon_model_finger_digit_v2___greyscale_1_test_vectors_.h"
...
static bool axon_selftest(void)
{
    ...
    const size_t n = sizeof(finger_digit_v2___greyscale_1_input_test_vectors) /
                      sizeof(finger_digit_v2___greyscale_1_input_test_vectors[0]);

    for (size_t i = 0; i < n; i++) {
        nrf_axon_result_e r = nrf_axon_nn_model_infer_sync(
            nrf_axon_compiled_model,
            (int8_t *)finger_digit_v2___greyscale_1_input_test_vectors[i],
        ...
        const int8_t *expected = finger_digit_v2___greyscale_1_expected_output_vectors[i];
